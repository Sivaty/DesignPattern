...
class main2 {
    ...
    class CashierSystem {
        ...
        static func calculateTotalPrice(commodityName: String, unitPrice: Float, number: Int, discount: Float) {
            
            let singleCommodityTotalPrice = unitPrice * Float(number) * discount
